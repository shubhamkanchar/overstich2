            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        ...
                        <form id="warehouseForm" method="POST" action="{{ route('seller.warehouse.store') }}">
                            <div class="card-body">
                                @csrf
                                <div class="form-group row">
                                    <div class="col-12 col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            placeholder="Warehouse Name" id="name" name="name"
                                    ...
                                    <div class="col-12 return-stage d-none col-md-4 mb-3">
                                        ...
                                        <input type="text" step="0.01" placeholder="Return Address"
                                            ...
                                            name="return_address" value="{{ old('return_address') }}" >
                                    ...
                                    <div class="col-12 return-stage d-none col-md-4 mb-3">
                                        ...
                                        <input type="number" placeholder="123456"
                                            ...
                                            name="return_pincode" value="{{ old('return_pincode') }}">
                                    ...
                                    <div class="col-12 return-stage d-none col-md-4 mb-3">
                                        ...
                                        <input type="text" placeholder="Return City"
                                            ...
                                            name="return_city" value="{{ old('return_city') }}">
                                        @error('return_city')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-12 return-stage d-none col-md-4 mb-3">
                                        ...
                                        <input type="text" placeholder="Return State"
                                            ...
                                            name="return_state" value="{{ old('return_state') }}">
                                        @error('return_state')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-12 return-stage d-none col-md-4 mb-3">
                                        ...
                                        <input type="text" placeholder="Return Country"
                                            ...
                                            name="return_country" value="{{ old('return_country') }}">
