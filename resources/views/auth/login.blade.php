        ...
        <div class="col-md-8">
            <div class="">
                <div class="card-header row">
                    <h4 style="font-weight:900" class="mb-3 offset-md-4">{{ __('Login') }} <small class="ms-3 me-3 fs-6 fw-light" >Or</small>
                    <a class="text-dark" href="{{ route('register') }}">Sign Up</a></h4>
                </div>
                <div class="card-body">
